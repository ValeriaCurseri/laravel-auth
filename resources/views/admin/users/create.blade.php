...
<div class="container">
    ...
    <form action="{{ (empty($user->id)) ? route('admin.users.store') : route('admin.users.update', $user) }}" method="post">
        @csrf
        @if (empty($user->id))
            @method('POST')
        @else
        ...
        <div class="form-row">
            ...
            <div class="form-check col-md-6 pl-3">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="mail" class="form-control" name="email" id="email" placeholder="es. mario.rossi@mail.com" value="{{ (empty($user->id)) ? old('mail') : $user->mail }}">
            </div>
